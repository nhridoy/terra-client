  ...
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
    ...
    <defs xmlns="http://www.w3.org/2000/svg">
      <radialGradient
        ...
        cy="0"
        r="1"
        gradientTransform="matrix(21.5958 0 0 16.55244 54.025 28.43)"
      ...
      <radialGradient
        ...
        cy="0"
        r="1"
        gradientTransform="matrix(-2.96054 187.84913 -160.21079 -2.5225 4.891 33.727)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stop-color="#fff" />
        <stop offset="34%" stop-color="#fff" />
      ...
      <linearGradient
        ...
        y1="0"
        y2="0"
        gradientTransform="rotate(79.19 168.776 -156.268) scale(428.36508)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stop-color="#fff" />
        <stop offset="34%" stop-color="#fff" />
      ...
      <linearGradient
        ...
        y1="0"
        y2="0"
        gradientTransform="rotate(-102.573 79.15 14.225) scale(111.47795)"
        gradientUnits="userSpaceOnUse"
      >
        <stop offset="0%" stop-color="#fff" />
        <stop offset="34%" stop-color="#fff" />
